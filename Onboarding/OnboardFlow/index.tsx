                ...
                <View key={index} style={{ width: containerWidth }}>
                  {pagesMerged[pageData.type]({
                    ...
                    style: [
                      pageStyle,
                      pageData.style
                        ? (pageData.style as StyleProp<ViewStyle>)
                        : null,
                    ],
                    textStyle: [
                      textStyle,
                      pageData.textStyle
                        ? (pageData.textStyle as StyleProp<TextStyle>)
                        : null,
                    ],
                    titleStyle: [
                      titleStyle,
                      pageData.titleStyle
                        ? (pageData.titleStyle as StyleProp<TextStyle>)
                        : null,
                    ],
                    subtitleStyle: [
                      subtitleStyle,
