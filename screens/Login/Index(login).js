...
        <ScrollView keyboardDismissMode={'on-drag'}>
            <View>
                ...
                <View style={appStyle.cardContainer}>
                    <TextInput  mode='outlined' theme={{ roundness: 20,colors: { primary: 'black',underlineColor:'transparent'}}}  underlineColor="outlined" style={appStyle.inputSearch} label="Email" placeholder="Email"></TextInput>
                </View>
                <View style={appStyle.cardContainer}>
                    <TextInput mode='outlined' underlineColor="outlined" theme={{ roundness: 20 }} 
                    style={appStyle.inputSearch} label="Password"></TextInput>
                </View>
