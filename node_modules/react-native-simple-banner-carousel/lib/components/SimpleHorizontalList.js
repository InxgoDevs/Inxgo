...
exports.SimpleHorizontalList = void 0;
const react_1 = __importStar(require("react"));
const react_native_1 = require("react-native");
const MARGIN = 8;
const INSET = -15;
function SimpleHorizontalList({ data, renderItem }) {
    const scrollX = (0, react_1.useRef)(new react_native_1.Animated.Value(0)).current;
    const [itemWidth] = (0, react_1.useState)(react_native_1.Dimensions.get('screen').width * 0.75);
    const [, setDataIndex] = (0, react_1.useState)(0);
    (0, react_1.useEffect)(() => {
    ...
    return (react_1.default.createElement(react_native_1.View, { style: {
        ...
        react_1.default.createElement(react_native_1.Animated.ScrollView, { horizontal: true, style: {
                ...
                x: 0,
                y: 0,
            }, snapToInterval: itemWidth + MARGIN * 2, showsHorizontalScrollIndicator: false, scrollEventThrottle: 16, snapToAlignment: "start", decelerationRate: "fast", pagingEnabled: true, onScroll: react_native_1.Animated.event([
                {
                    nativeEvent: {
...
exports.SimpleHorizontalList = SimpleHorizontalList;
